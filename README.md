...
| **Dashboard build prompt set** (master + 22 step prompts; M1 HR & ERI + M2 document/letter flows) | AI assistants and contributors building the SPA | [`docs/dashboard-prompts/`](./docs/dashboard-prompts/) |
