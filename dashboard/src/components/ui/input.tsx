...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // h-10 (40px) is the dashboard's mobile-first comfortable touch target —
        // h-8 (the shadcn Nova-preset default) reads cramped on phones and
        // doesn't visually align with SelectTrigger after its own h-10 bump.
