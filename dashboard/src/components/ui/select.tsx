...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // h-10 (default) matches Input's h-10 so trigger and inputs align in
        // form rows; h-8 (sm) for compact contexts. NOTE: the data-[size=*]
        // attribute selectors have CSS specificity (0,1,1) which beats a
        // consumer's plain `h-12` className (0,1,0). If you need a taller
        // trigger, pass `size="default"` (already default) and override with
        // `!h-12` or use a data-attribute selector at matching specificity.
        // See ai_context/LESSONS.md "Form-control height" entry.
